...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    // === DÉTAIL DE LA CARTE (CarteViewer) ===
    ...
    'cartotheque.detail.author': 'Auteur',
    'cartotheque.detail.source': 'Source',
    'cartotheque.detail.keywords': 'Mots-clés',
    'cartotheque.detail.date': 'Date de création',
    'cartotheque.detail.extent': 'Emprise',

    // === VIEWER (alias compatibilité) ===
  ...
  kab: {
    ...
    'cartotheque.no.results.search': 'Ɖeɖee nɛ ɖoɖo',
    'cartotheque.no.results.domain': 'Kaatɩ ɖeɛ kɩcɛyʊ nɛ',
    ...
    'cartotheque.loading.map': 'Kaatɩ ɖɩtaɩ...',
    ...
    'cartotheque.detail.layers': 'Kpasɩ nɛ ɖɩtaɩ',
    'cartotheque.detail.type': 'Kaatɩ kʊ',
    'cartotheque.detail.features': 'tɔm kɩdɛŋ',
    'cartotheque.detail.basemap': 'Kaatɩ tɩŋtɩŋ',
    'cartotheque.detail.author': 'Kɩkɛʋ',
    'cartotheque.detail.source': 'Tɔm kɩdɛŋ',
    'cartotheque.detail.keywords': 'Kɩlaʋ kpasɩ',
    'cartotheque.detail.date': 'Ɖɩtaɩ kɩlaʋ',
    'cartotheque.detail.extent': 'Emprise',

    // === VIEWER ===
    'cartotheque.viewer.info': 'Tɔm kɛdɛŋ',
    'cartotheque.viewer.layers': 'Kpasɩ',
    'cartotheque.viewer.description': 'Ɖeɖee nɛ',
    'cartotheque.viewer.author': 'Kɩkɛʋ',
    'cartotheque.viewer.source': 'Tɔm kɩdɛŋ',
    'cartotheque.viewer.keywords': 'Kɩlaʋ kpasɩ',
    'cartotheque.viewer.associated_layers': 'Kpasɩ nɛ ɖɩtaɩ',
    'cartotheque.viewer.extent': 'Emprise',
    'cartotheque.viewer.no_layers': 'Kpasɩ ɖeɛ ɖɩtaɩ',
    'cartotheque.viewer.loading_geojson': 'Tɔm kɛdɛŋ ɖɩtaɩ...',
  ...
  ewe: {
    ...
    'cartotheque.no.results.search': 'Nutiɖe o le dii me',
    'cartotheque.no.results.domain': 'Nunana maɖe o le dome sia me',
    ...
    'cartotheque.detail.author': 'Wɔla',
    'cartotheque.detail.source': 'Gɔme',
    'cartotheque.detail.keywords': 'Nyawo',
    'cartotheque.detail.date': 'Ŋkekea wo dze',
    'cartotheque.detail.extent': 'Emprise',

    // === VIEWER ===
    'cartotheque.viewer.info': 'Nudzɔdzɔ',
    'cartotheque.viewer.layers': 'Kpakpe',
    'cartotheque.viewer.description': 'Nudzɔdzɔ',
    'cartotheque.viewer.author': 'Wɔla',
    'cartotheque.viewer.source': 'Gɔme',
    'cartotheque.viewer.keywords': 'Nyawo',
    'cartotheque.viewer.associated_layers': 'Kpakpe siwo le eme',
    'cartotheque.viewer.extent': 'Emprise',
    'cartotheque.viewer.no_layers': 'Kpakpe maɖe o le eme',
    'cartotheque.viewer.loading_geojson': 'Nudzɔdzɔ geographique le wɔm...',
