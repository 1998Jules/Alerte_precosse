...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'cartotheque.detail.specs': 'Fiche technique',
    'cartotheque.detail.scale': 'Échelle',
    'cartotheque.detail.print_format': "Format d'impression",
    'cartotheque.detail.edition_date': "Date d'édition",
    'cartotheque.detail.realisateur': 'Réalisateur',
    'cartotheque.detail.price': 'Prix',
    'cartotheque.detail.image_unavailable': 'Image non disponible',
    'cartotheque.detail.no_image': 'Aucune image associée à cette carte',
    'cartotheque.badge.paid': 'Payant',
    'cartotheque.badge.free': 'Gratuit',
    'cartotheque.download': 'Télécharger',
    'cartotheque.download.free': 'Télécharger gratuitement',
    'cartotheque.download.paid': 'Accès payant',
  ...
  kab: {
    ...
    'cartotheque.detail.extent': 'Emprise',
    'cartotheque.detail.specs': 'Tɔm kɩdɛŋ kpasɩ',
    'cartotheque.detail.scale': 'Echelle',
    'cartotheque.detail.print_format': 'Format',
    'cartotheque.detail.edition_date': 'Ɖɩtaɩ kɩlaʋ',
    'cartotheque.detail.realisateur': 'Kɩkɛʋ',
    'cartotheque.detail.price': 'Ahozigbe',
    'cartotheque.detail.image_unavailable': 'Nɩnʋʋ ɖeɛ ɖoɖo',
    'cartotheque.detail.no_image': 'Nɩnʋʋ ɖeɛ kaatɩ nɛ',
    'cartotheque.badge.paid': 'Ahozigbe',
    'cartotheque.badge.free': 'Ahozigbe ɖeɛ',
    'cartotheque.download': 'Ɖɩtɩ',
    'cartotheque.download.free': 'Ɖɩtɩ ahozigbe ɖeɛ',
    'cartotheque.download.paid': 'Ahozigbe kɩdɛŋ',
  ...
  ewe: {
    ...
    'cartotheque.detail.extent': 'Emprise',
    'cartotheque.detail.specs': 'Nudzɔdzɔ ƒe xexe',
    'cartotheque.detail.scale': 'Echelle',
    'cartotheque.detail.print_format': 'Format',
    'cartotheque.detail.edition_date': 'Ŋkekea wo dze',
    'cartotheque.detail.realisateur': 'Wɔla',
    'cartotheque.detail.price': 'Xɔse',
    'cartotheque.detail.image_unavailable': 'Nɔnɔme mede o',
    'cartotheque.detail.no_image': 'Nɔnɔme mede nunana o',
    'cartotheque.badge.paid': 'Xɔse',
    'cartotheque.badge.free': 'Xɔse mede o',
    'cartotheque.download': 'Ɖe eme',
    'cartotheque.download.free': 'Ɖe eme xɔse mede o',
    'cartotheque.download.paid': 'Xɔse ƒe mɔ',
